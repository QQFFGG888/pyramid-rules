...
叠加十条规则边界：双端自包含、纯交付物、自然引导、章末检验、一句一事实、富文本辅助、符号从简、数字编号三级标题、文首元信息、去 AI 感润色。

## 2 目录结构

```
pyramid-tutorial/
├── SKILL.md                    # 技能主文件：触发条件、生成流程、输出格式
├── references/
│   ├── pyramid-rules.md        # 四层逐层填充规则、铁律、正反例
│   ├── blocks.md               # 可复用区块模板：元信息、三栏表、自检等
...
v4。目录结构升级：示例迁至 examples/，自检配方落成 scripts/selfcheck.sh。
